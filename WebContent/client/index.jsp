			...
			<tr>
				<td width="497">
					...
					<table cellspacing="0" class="ctl">
						<tr>
							<td width="485" height="29" style="line-height:20px;font-size: 16px;">${n.details }</td>
						</tr>
					</table>
				</td>
						...
						<c:forEach items="${pList }" var="pArray">
							<td style="width:80; text-align:center">
								<a href="${pageContext.request.contextPath}/findProductById?id=${pArray[0]}">
									<img src="${pageContext.request.contextPath}/downServlet?fileName=${pArray[2]}" width="102" height="130" border="0" /> 
								</a>
								<br /> 
